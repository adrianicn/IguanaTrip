...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Adventure Trips - Not miss any hotel, bar, event or place in Ecuador- iWaNaTrip es experiencia de vida. Deja de ser turista, conviertete en viajero. Viaja por el mundo y descubre Ecuador">
               ...
               @else
                   ...
                   <div class="heading-box col-md-10 col-lg-8">
                    ...
                    <!--<div class="heading-box col-md-10 col-lg-8">
                     ...
                     <div class="heading-box col-md-10 col-lg-8">
                    <h2 class="box-title">{{ trans('publico/labels.label138')}} <em class="skin-color">{!!$titulo!!}</em> {{ trans('publico/labels.label139')}}</h2>
                    <p><em class="skin-color">iWaNaTrip</em> {{ trans('publico/labels.label133')}}</p>
                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="icon-box style-side-2 animated box" data-animation-type="fadeInUp" data-animation-delay="0">
                                ...
                                <div class="box-content">
                                    <h4 class="box-title"><a href="{!!asset('/tokenDz$rip')!!}/4"  onclick="$('.parallax').LoadingOverlay('show')">{{ trans('publico/labels.label130')}}</a></h4>
                                    <p>{{ trans('publico/labels.label133')}} {!!$titulo!!} {{ trans('publico/labels.label134')}} </p>
                                    <a href="{!!asset('/tokenDz$rip')!!}/4"  onclick="$('.parallax').LoadingOverlay('show')" class="btn btn-sm style4 hover-blue">More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="icon-box style-side-2 animated box" data-animation-type="fadeInUp" data-animation-delay="0.5">
                                ...
                                <div class="box-content">
                                    <h4 class="box-title"><a href="{!!asset('/tokenDz$rip')!!}/1"  onclick="$('.parallax').LoadingOverlay('show')">{{ trans('publico/labels.label131')}}</a></h4>
                                    <p>{{ trans('publico/labels.label135')}} {!!$titulo!!} {{ trans('publico/labels.label136')}} </p>
                                    <a href="{!!asset('/tokenDz$rip')!!}/1"  onclick="$('.parallax').LoadingOverlay('show')" class="btn btn-sm style4 hover-blue">More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="icon-box style-side-2 animated box" data-animation-type="fadeInUp" data-animation-delay="1">
                                <i class="fa fa-bed"></i>
                                <div class="box-content">
                                    <h4 class="box-title"><a href="{!!asset('/tokenDz$rip')!!}/2"  onclick="$('.parallax').LoadingOverlay('show')">{{ trans('publico/labels.label132')}}</a></h4>
                                    <p>{!!$titulo!!} {{ trans('publico/labels.label137')}}</p>
                                    <a href="{!!asset('/tokenDz$rip')!!}/2"  onclick="$('.parallax').LoadingOverlay('show')" class="btn btn-sm style4 hover-blue">More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="theme-features">
                        <div class="overflow-hidden">
                            <div class="row same-height">
                                <div class="col-sm-6">
                                    <div class="image-box row animated" data-animation-type="fadeInLeft" data-animation-duration="2" data-animation-delay="0">
                                        <div class="col-sms-4 col-sm-4 image-container fixed">
                                            <img src="{{ asset('img/trips/trip1.png')}}" alt="">
                                        </div>
                                        <div class="col-sms-8 col-sm-8 details">
                                            <h3 class="title">User Friendly Layouts</h3>
                                            <p>Aliquam hendrerit a augue in suscipit. Pellentesque id erat quis sapien dignissim sollicitudin. Nulla mattis tortor sit amet dolor sollicitudin aliquam.</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="image-box row animated" data-animation-type="fadeInLeft" data-animation-duration="2" data-animation-delay="0">
                                        ...
                                        <div class="col-sms-8 col-sm-8 details">
                                            <h3 class="title">Retina Ready Display</h3>
                                            <p>Aliquam hendrerit a augue in suscipit. Pellentesque id erat quis sapien dignissim sollicitudin. Nulla mattis tortor sit amet dolor sollicitudin aliquam.</p>
                                            <a href="#" class="btn btn-sm style4 hover-blue">More</a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="image-box row animated" data-animation-type="fadeInLeft" data-animation-duration="2" data-animation-delay="0.5">
                                        ...
                                        <div class="col-sms-8 col-sm-8 details">
                                            <h3 class="title">Full Responsive Layouts</h3>
                                            <p>Aliquam hendrerit a augue in suscipit. Pellentesque id erat quis sapien dignissim sollicitudin. Nulla mattis tortor sit amet dolor sollicitudin aliquam.</p>
                                            <a href="#" class="btn btn-sm style4 hover-blue">More</a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="image-box row animated" data-animation-type="fadeInLeft" data-animation-duration="2" data-animation-delay="0">
                                        ...
                                        <div class="col-sms-8 col-sm-8 details">
                                            <h3 class="title">Unlimited Shortcodes</h3>
                                            <p>Aliquam hendrerit a augue in suscipit. Pellentesque id erat quis sapien dignissim sollicitudin. Nulla mattis tortor sit amet dolor sollicitudin aliquam.</p>
                                            <a href="#" class="btn btn-sm style4 hover-blue">More</a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="image-box row animated" data-animation-type="fadeInLeft" data-animation-duration="2" data-animation-delay="0.5">
                                        ...
                                        <div class="col-sms-8 col-sm-8 details">
                                            <h3 class="title">Endless Possibilities</h3>
                                            <p>Aliquam hendrerit a augue in suscipit. Pellentesque id erat quis sapien dignissim sollicitudin. Nulla mattis tortor sit amet dolor sollicitudin aliquam.</p>
                                            <a href="#" class="btn btn-sm style4 hover-blue">More</a>
                                        </div>
                                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="features-icon-slider owl-carousel box-lg" data-items="6">
                                ...
                                @if(session('locale') == 'es' )
                                           <a href="{!!asset('/tokenDz$rip')!!}/1"  onclick="$('.parallax').LoadingOverlay('show')" class="feature-icon"><i class="fa fa-cutlery"></i><div style="alignment-baseline: central">AlimentaciÃ³n y bebidas</div></a>
                                   ...
                                   <figure ><img src="{{ asset('img/galapagos.jpg')}}" alt=""></figure>
                                     @if(session('device')!='mobile')
                                        <div class="shortcode-banner-inside" style=" width: 108%;">
                                            ...
                                            @endif
                                    <div class="shortcode-banner-content">
                                        <a href="{!!asset('/getRegionDescipcion/4')!!}" onclick="$('.iso-container').LoadingOverlay('show');"><h3  class="banner-title">GalÃ¡pagos</h3>
                                        </a>
                                        <div class="details">
