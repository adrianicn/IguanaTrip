...
<!--[if gt IE 9]><!-->  <html> <!--<![endif]-->
    <head>
        <!-- Page Title -->
        <title>iWaNaTrip | {{ trans('responsive.lables.label32')}}</title>
    ...
    <body class="woocommerce">
        ...
        <div id="page-wrapper">
            ...
            <ul class="breadcrumbs">
                <li class="active">{{ trans('responsive.lables.label32')}}</li>
            </ul>
        </div>
            <script type='text/javascript'>
			   swal(
                          '{{ trans("responsive.lables.label10")}}',
			  '{{ trans("responsive.lables.label11")}}',
			  'success');
            </script>
            <section id="content">
            <div class="container">
