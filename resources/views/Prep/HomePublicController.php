...
class HomePublicController extends Controller {
    ...
    public function getbyCity(Request $request, PublicServiceRepository $gestion, $city) {
        ...
        $eventosClose = $gestion->getEventsIndepCity($city, 100, 4); //$eventosClose = $gestion->getEventsIndepCity(ciudad,take,pagination);
        $eventosDepClose = $gestion->getEventsDepCity($city, 100, 4); //$eventosClose = $gestion->getEventsIndepCity(ciudad,take,pagination);
        $PromoDepClose = $gestion->getPromoDepCity($city, 100, 4); //$eventosClose = $gestion->getEventsIndepCity(ciudad,take,pagination);
    ...
    public function getcloseToMe(Request $request, PublicServiceRepository $gestion, $city) {
        ...
        $AtraccionesClose = $gestion->getAtraccionesByCity($city, 100, 4);
...
$tipoReviews = $gestion->getTiporeviews($id_atraccion);
    ...
    public function getCatalosoServiciosSearch(Request $request, PublicServiceRepository $gestion, $id_catalogo,$ciudad ) {
        ...
        $busquedaInicial = $gestion->getBusquedaInicialCatalogo($id_catalogo,$ciudad,null,null,500,3);
